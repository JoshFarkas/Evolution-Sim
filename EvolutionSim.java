...
public class EvolutionSim {
   ...
   public static void main(String[] args) {
      ...
      EvolutionSim sim;
      if (askBool("Use Custom Parameters?")) {
         sim = new EvolutionSim(
            askInt("World Size (20):"),
   ...
   public void initOrganisms(int n) {
      for (int i = 0; i < n; i++) {
         Organism o = new Organism(rand.nextInt(worldSize), rand.nextInt(worldSize), rand.nextInt(5) + 1, rand.nextInt(4) +  1);
         organisms.add(o);
